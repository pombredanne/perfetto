...
class ProducerIPCProxy : public Service::ProducerEndpoint,
                         public ipc::ServiceProxy::EventListener {
 public:
  ProducerIPCProxy(Producer*, base::TaskRunner*);
  ~ProducerIPCProxy() override;
  ...
  // The (owned) IPC object used to send requests thorugh the IPC channel.
  // ProducerPortProxy is autogenerated by the IPC layer from the
  // producer_port.proto service definition.
  ProducerPortProxy* ipc_endpoint() { return &ipc_endpoint_; }
 ...
 private:
  ...
  ProducerPortProxy ipc_endpoint_;
