...
class PERFETTO_EXPORT TraceStats {
 public:
  ...
  uint32_t chunks_discarded() const { return chunks_discarded_; }
  void set_chunks_discarded(uint32_t value) { chunks_discarded_ = value; }

  uint32_t patches_discarded() const { return patches_discarded_; }
  void set_patches_discarded(uint32_t value) { patches_discarded_ = value; }
 ...
 private:
  ...
  uint32_t chunks_discarded_ = {};
  uint32_t patches_discarded_ = {};
