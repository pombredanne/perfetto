...
#ifndef SRC_PROTOZERO_SCATTERED_STREAM_MEMORY_DELEGATE_H_
#define SRC_PROTOZERO_SCATTERED_STREAM_MEMORY_DELEGATE_H_
...
#endif  // SRC_PROTOZERO_SCATTERED_STREAM_MEMORY_DELEGATE_H_
