...
#ifndef SRC_TRACE_PROCESSOR_ASYNC_SLICE_TABLE_H_
#define SRC_TRACE_PROCESSOR_ASYNC_SLICE_TABLE_H_
...
class AsyncSliceTable : public Table {
 public:
  enum Column {
    kTimestamp = 0,
    kDuration = 1,
  ...
  AsyncSliceTable(sqlite3*, const TraceStorage* storage);
...
#endif  // SRC_TRACE_PROCESSOR_ASYNC_SLICE_TABLE_H_
