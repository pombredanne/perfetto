...
#include "perfetto/tracing/core/android_logcat_config.h"

#include "perfetto/common/android_logcat_constants.pb.h"
#include "perfetto/config/android/android_logcat_config.pb.h"

namespace perfetto {

AndroidLogcatConfig::AndroidLogcatConfig() = default;
AndroidLogcatConfig::~AndroidLogcatConfig() = default;
AndroidLogcatConfig::AndroidLogcatConfig(const AndroidLogcatConfig&) = default;
AndroidLogcatConfig& AndroidLogcatConfig::operator=(
    const AndroidLogcatConfig&) = default;
AndroidLogcatConfig::AndroidLogcatConfig(AndroidLogcatConfig&&) noexcept =
    default;
AndroidLogcatConfig& AndroidLogcatConfig::operator=(AndroidLogcatConfig&&) =
    default;

void AndroidLogcatConfig::FromProto(
    const perfetto::protos::AndroidLogcatConfig& proto) {
  log_ids_.clear();
...
void AndroidLogcatConfig::ToProto(
    perfetto::protos::AndroidLogcatConfig* proto) const {
  proto->Clear();
